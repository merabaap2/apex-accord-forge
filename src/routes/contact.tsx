...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — R&A Associates" },
      { name: "description", content: "Initiate a confidential consultation with a senior partner at R&A Associates." },
      { property: "og:title", content: "Contact — R&A Associates" },
      { property: "og:description", content: "Initiate a confidential consultation with a senior partner." },
    ],
  }),
  component: Contact,
});
