...
export const Route = createFileRoute("/who-we-are")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Three decades of ingrained values, distinguished team and unyielding work ethic at R&A Associates." },
      { property: "og:title", content: "Who We Are — R&A Associates" },
      { property: "og:description", content: "The values, people and ethic behind R&A Associates." },
    ],
  }),
  component: WhoWeAre,
});
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-9 space-y-32">
            ...
            <article id="team" className="scroll-mt-28">
              ...
              <div className="mt-10 aspect-[16/10] overflow-hidden bg-muted">
                <img src={office} alt="Our team" loading="lazy" width={1280} height={1600} className="h-full w-full object-cover" />
              </div>
            ...
            <article id="facilities" className="scroll-mt-28">
              ...
              <div className="mt-10 aspect-[16/9] overflow-hidden bg-muted">
                <img src={boardroom} alt="Boardroom" loading="lazy" width={1600} height={1024} className="h-full w-full object-cover" />
              </div>
              <p className="mt-8 text-muted-foreground max-w-2xl">
              ...
              <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-3">
                {[office, boardroom, office, boardroom].map((src, i) => (
                  <div key={i} className="aspect-square overflow-hidden bg-muted">
                    <img src={src} alt="" loading="lazy" className="h-full w-full object-cover grayscale hover:grayscale-0 transition-all duration-700" />
                  </div>
                ))}
              </div>
            </article>
