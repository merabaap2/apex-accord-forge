...
export const Route = createFileRoute("/knowledge")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Editorial briefs, newsletters and case studies from R&A Associates." },
      { property: "og:title", content: "Knowledge Centre — R&A Associates" },
      { property: "og:description", content: "Editorial briefs, newsletters and case studies." },
    ],
  }),
  component: Knowledge,
});
